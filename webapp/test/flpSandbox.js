		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Bankruptcy Process",
									"targetURL": "#comokwutmngbnkprcszmngbnkprcs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comokwutmngbnkprcszmngbnkprcs-display": {
								"semanticObject": "comokwutmngbnkprcszmngbnkprcs",
								"action": "display",
								"description": "Manage Bankruptcy Process",
								"title": "Manage Bankruptcy Process",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.okwut.mngbnkprcs.zmngbnkprcs",
									"url": sap.ui.require.toUrl("com/okwut/mngbnkprcs/zmngbnkprcs")
								}
							}
						}
					}
